    ...
    <footer className="mt-24 border-t border-line bg-ink text-accent-fg">
      <div className="mx-auto grid max-w-7xl gap-10 px-4 py-14 sm:px-6 md:grid-cols-4">
        ...
        <div className="flex flex-col gap-2 text-sm">
          ...
          <Link to="/agents" className="text-accent-fg/80 hover:text-accent-fg">
            Agents
          </Link>
          <Link to="/agencies" className="text-accent-fg/80 hover:text-accent-fg">
            Agencies
          </Link>
        </div>
        <div className="flex flex-col gap-2 text-sm">
          <p className="mb-1 text-xs uppercase tracking-[0.16em] text-accent-fg/50">Practice</p>
          <Link to="/login" className="text-accent-fg/80 hover:text-accent-fg">
            Client access
          </Link>
          <Link to="/dashboard/agent" className="text-accent-fg/80 hover:text-accent-fg">
            List a property
          </Link>
        </div>
      </div>
