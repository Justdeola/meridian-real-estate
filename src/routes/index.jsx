  ...
  return (
    <AppShell>
      <section className="relative min-h-[78vh] overflow-hidden">
        <img
          src={HERO_IMAGE}
          alt="A considered family house at dusk"
        ...
        <div className="relative mx-auto flex min-h-[78vh] max-w-7xl flex-col justify-end gap-8 px-4 pb-16 pt-28 sm:px-6">
          <motion.div
            ...
            className="max-w-2xl text-accent-fg"
          >
            <p className="text-xs uppercase tracking-[0.22em] text-accent-fg/70">
              Private listings · Nigeria
            </p>
            <h1 className="mt-3 font-display text-5xl leading-[0.95] sm:text-6xl lg:text-7xl">
              {APP_TAGLINE}
            </h1>
            <p className="mt-4 max-w-lg text-base text-accent-fg/80">
              Distinctive homes, residences and commercial property — presented with the care of a
              private practice.
            </p>
          </motion.div>
          <motion.div
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6">
        <Header
          kicker="Featured"
          title="Residences currently in view"
          to="/properties"
        ...
        <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 md:grid-cols-3">
          {[
            [
              "01",
              "Exact particulars",
              "Measured photography, verified title notes, and agents who have walked the rooms.",
            ],
            [
              "02",
              "Private viewings",
              "Request a time. The listing agent confirms, reschedules, or completes the appointment in one place.",
            ],
            [
              "03",
              "A quiet market",
              "Saved searches, considered filters, and listings that do not shout.",
            ],
          ].map(([n, t, b]) => (
            <div key={n}>
      ...
      <section className="mx-auto max-w-7xl px-4 py-20 sm:px-6">
        <Header
          ...
          to="/properties"
          search={{ newListing: true, sort: "newest" }}
        />
  ...
  return (
    <div className="mb-8 flex items-end justify-between gap-4">
      ...
      <Link
        to={to}
        search={search}
        className="hidden items-center gap-1 text-sm text-muted hover:text-ink sm:inline-flex"
      >
